...
from .ui.config_editor import IndicatorEditor, setup_config_editor_ui
...
class ConfigEditor(QMainWindow):
    ...
    def _edit_indicators(self, button):
        editor = IndicatorEditor(
            button.property("indicators") or [],
            self._calculate_bit_settings,
            self,
        )
