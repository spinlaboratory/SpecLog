...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_6.setMinimumSize(QSize(360, 0))
        self.groupBox_6.setMaximumSize(QSize(360, 16777215))
        ...
        self.groupBox.setMinimumSize(QSize(360, 131))
        self.groupBox.setMaximumSize(QSize(360, 131))
        self.formLayout = QFormLayout(self.groupBox)
        self.formLayout.setObjectName(u"formLayout")
        self.label_3 = QLabel(self.groupBox)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setMinimumSize(QSize(125, 20))
        self.label_3.setMaximumSize(QSize(125, 20))
        ...
        self.formLayout.setWidget(0, QFormLayout.ItemRole.FieldRole, self.startTime)

        self.label_4 = QLabel(self.groupBox)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setMinimumSize(QSize(125, 20))
        self.label_4.setMaximumSize(QSize(125, 20))

        self.formLayout.setWidget(1, QFormLayout.ItemRole.LabelRole, self.label_4)

        self.durationContainer = QWidget(self.groupBox)
        self.durationContainer.setObjectName(u"durationContainer")
        self.durationContainer.setMinimumSize(QSize(200, 23))
        self.durationContainer.setMaximumSize(QSize(200, 23))
        self.durationLayout = QHBoxLayout(self.durationContainer)
        self.durationLayout.setSpacing(4)
        self.durationLayout.setObjectName(u"durationLayout")
        self.durationLayout.setContentsMargins(0, 0, 0, 0)
        self.durationValue = QDoubleSpinBox(self.durationContainer)
        self.durationValue.setObjectName(u"durationValue")
        self.durationValue.setDecimals(2)
        self.durationValue.setMaximum(100000.000000000000000)
        self.durationValue.setSingleStep(1.000000000000000)

        self.durationLayout.addWidget(self.durationValue)

        self.durationUnit = QComboBox(self.durationContainer)
        self.durationUnit.addItem("")
        self.durationUnit.addItem("")
        self.durationUnit.setObjectName(u"durationUnit")

        self.durationLayout.addWidget(self.durationUnit)


        self.formLayout.setWidget(1, QFormLayout.ItemRole.FieldRole, self.durationContainer)
        ...
        self.formLayout.setWidget(2, QFormLayout.ItemRole.LabelRole, self.setToLive)
        ...
        self.formLayout.setWidget(2, QFormLayout.ItemRole.FieldRole, self.setToStatic)
        ...
        self.groupBox_2.setMinimumSize(QSize(360, 301))
        self.groupBox_2.setMaximumSize(QSize(360, 301))
        ...
        self.groupBox_4.setMaximumSize(QSize(16777215, 121))
        ...
        self.groupBox_5.setMinimumSize(QSize(360, 53))
        self.groupBox_5.setMaximumSize(QSize(360, 53))
        ...
        self.graphWidget.setMinimumSize(QSize(511, 461))
        ...
        self.groupBox_3.setMinimumSize(QSize(452, 121))
        self.groupBox_3.setMaximumSize(QSize(16777215, 121))
        self.systemStatusLayout = QHBoxLayout(self.groupBox_3)
...
"	border:2px solid white;}")
        ...
        self.systemStatusLayout.addWidget(self.systemStatus, 0, Qt.AlignCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.startTime.setPlaceholderText(QCoreApplication.translate("MainWindow", u"yyyymmddHHMM", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Duration", None))
        self.durationValue.setSpecialValueText(QCoreApplication.translate("MainWindow", u"All", None))
        self.durationUnit.setItemText(0, QCoreApplication.translate("MainWindow", u"Hours", None))
        self.durationUnit.setItemText(1, QCoreApplication.translate("MainWindow", u"Days", None))
